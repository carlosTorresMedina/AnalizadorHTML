...
public class ListaCD<T> implements Iterable<T> {
     ...
     * sirve como cabecera de la ListaCD<T>
     */
    public ListaCD() {
    ...
    /**
     * Busca un elemento de la lista y devuelve su posicion.Los objetos que se
     * almacenan en la lista deben tener el Método equals.
     *
    ...
    /**
     * Adiciona un Objeto en forma Ordenada, la clase debe tener el m�todo
     * compareTo
     *
     ...
     * @return un boolean, si es true concateno las listas y si es false no.
     */
    ...
    /**
     * Devuelve un String con toda la informaci�n de los elementos de la Lista.
     * Recomendaci�n: La clase que se almacena en la Lista debe tener
     * sobreescrito el m�todo toString()
     *
    ...
    /**
     * busca un elemento en la lista si lo encuentra retorna true, de lo
     * contrario false
     *
